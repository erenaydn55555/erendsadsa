...
let salvoembed = new Discord.MessageEmbed().setColor(0x7997ff).setFooter(`Erenaydn55 💛 CHESTERFIELD`).setAuthor(message.author.username, message.author.avatarURL({dynamic: true}))
...
setTimeout(function() {
  ...
  qdb.fetch(`chatmutenick_${user.id}_${message.guild.id}`)
